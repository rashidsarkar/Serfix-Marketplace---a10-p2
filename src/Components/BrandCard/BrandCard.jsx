...
function BrandCard({ item }) {
  ...
  return (
    <Link to={`/brand/${brandName}`}>
      <div className="block max-w-[18rem] md:max-w-[22rem] lg:max-w-[25rem] mx-auto rounded-lg  shadow-[0 2px 15px -3px rgba(0,0,0,0.07), 0 10px 20px -2px rgba(0,0,0,0.04)] dark:bg-neutral-700 bg-base-300 shadow-xl">
